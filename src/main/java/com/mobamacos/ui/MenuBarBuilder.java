...
import com.mobamacos.ui.dialogs.TunnelManagerDialog;
...
public class MenuBarBuilder {
    ...
    private JMenu fileMenu() {
        ...
        JMenuItem exit = item("Quit MobaMacOS", KeyEvent.VK_Q,
    ...
    private JMenu helpMenu() {
        ...
        JMenuItem about = item("About MobaMacOS", 0, null);
        about.addActionListener(e ->
                JOptionPane.showMessageDialog(parent,
                        "<html><b>MobaMacOS Terminal</b><br>Version 0.1 (POC)<br><br>" +
                        "A MobaXterm-inspired SSH client for macOS,<br>" +
                        "built with JediTerm + JSch + FlatLaf.</html>",
    ...
    private void showNewConnectionDialog(com.mobamacos.model.ServerFolder folder) {
    ...
    private void promptNewFolder() {
        ...
        if (name != null && !name.isBlank()) {
            configManager.getConfig().getFolders().add(
                    new com.mobamacos.model.ServerFolder(name.strip()));
